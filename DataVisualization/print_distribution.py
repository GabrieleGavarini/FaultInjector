...
ax[0].bar(x=top_non_faulty_values_over_threshold.index, height=top_non_faulty_values_over_threshold.values, width=1, color='blue', label='False Positive')
...
ax[1].bar(x=top_faulty_values_over_threshold.index, height=top_faulty_values_over_threshold.values, width=1, color='red', label='True Positive')
...
fig.show()
fig.savefig('Distribution-no_fault_detector')
